    ...
    internal class VisualRow
    {
        ...
        public TextBox TextBox
        {
            ...
            set
            {
                ...
                {
                    double diff = (double)(_maxval - _minval) * 0.2;
                    ...
                    {
                        case 22:
                            val = _random.NextDouble((double)_minval + ((double)_maxval * 0.6), (double)_maxval - (diff / 2));
                            break;
                        case 11:
                            val = _random.NextDouble((double)_minval + (diff / 2), (double)_maxval - ((double)_minval * 0.65));
                            break;
                        case 8:
                            val = _random.NextDouble((double)_minval + ((double)_maxval * 0.75), (double)_maxval - (diff / 2));
                            break;
                        case 9:
                            val = _random.NextDouble((double)_minval + ((double)_maxval * 0.65), (double)_maxval - (diff / 2));
                            break;
                        case 10:
                            val = _random.NextDouble((double)_minval + ((double)_maxval * 0.65), (double)_maxval - (diff / 2));
                            break;
                        default:
                            val = _random.NextDouble((double)_minval + diff, (double)_maxval - diff);
                            break;
                    }
