...
{
    public partial class VipAvtoDBDataSet
    {
        ...
        ModelTableAdapter _modelTableAdapter = new ModelTableAdapter();
        ...
        public DataRow GetRowById(string tableName, int id)
        {
            switch (tableName)
            {
                ...
                case Constants.ModelTableName:
                    return Model.FindByIdModel(id);
                case Constants.VendorTableName:
                    return Vendor.FindByIdVendor(id);
                default:
                    return null;
            }
        }
        ...
        public void Update(Type type)
        {
            ...
            else if (typeof(VendorRow) == type)
            {
                 _vendorTableAdapter.Update(Vendor);
            }
            else if (typeof(ModelRow) == type)
            {
                _modelTableAdapter.Update(Model);
            }
        ...
        public int AddProtocol(string blankNumber, string mechanicName, DateTime dateTime,
            ...
            DateTime nexDateTime, bool visChck, byte gbo)
        {
        ...
        public void LoadData()
        {
            ...
            _modelTableAdapter.Fill(Model);
            _vendorTableAdapter.Fill(Vendor);
        }
